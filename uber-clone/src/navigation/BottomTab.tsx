  ...
  return (
    <BottomTab.Navigator
      ...
      tabBarOptions={{
        ...
        style: { height: 65 },
        labelStyle: { fontSize: 14, alignItems: "center" },
        tabStyle: {
          paddingVertical: 10,
        },
      }}
    >
      <BottomTab.Screen
        ...
        options={{
          tabBarIcon: ({ color }) => (
            <Icon viewBox="0 0 394.648 394.648" color={color} size={6} ml="2px">
      ...
      <BottomTab.Screen
        ...
        options={{
          tabBarIcon: ({ color }) => (
            <Icon ml={-1} viewBox="0 0 394.648 394.648" color={color} size={5}>
